...
const users = [
  {
    ...
    gender: 'M',
    deliveryPreferences: {
      mealsPerWeek: faker.random.number(1, 4),
      minDeliveriesPerWeek: faker.random.number(1, 4),
      maxDeliveriesPerWeek: faker.random.number(1, 4),
      servingsPerMeal: faker.random.number(1, 4)
    }
  },
  {
