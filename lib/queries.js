...
const ingredientsFetchFields = {
    ingredients: ['id', 'name_singular', 'name_plural', 'description', 'is_composite', 'serving_size', 'est_unit_price', 'total_size'],
    tags: ['id', 'name'],
...
const recipesFetchFields = {
    ...
    tags: ['id', 'name'],
    stepTags: ['id'],
    ingredients: ['id', 'name_singular', 'name_plural', 'description', 'serving_size', 'is_composite', 'est_unit_price', 'total_size'],
    units: ['id', 'name_singular', 'name_plural', 'abbreviation'],
    ingredientTags: ['id'],
